...
def output_hub_data(output_location, sequencing_files):
    for file in sequencing_files:
        ...
        if "-dedup-FW-KF297339.1.bw" in file:
            ending_to_replace = "-dedup-FW-KF297339.1.bw"
        elif "-dedup-KF297339.1-FW.bw" in file:
            ending_to_replace = "-dedup-KF297339.1-FW.bw"
        else:
            print("I can't work with this format. Exiting ...")
            sys.exit(1)
