...
from GC_bioinfo.utils.heatmap_utils.get_max_value_from_matrix import get_max_value_from_matrix
from GC_bioinfo.utils.heatmap_utils.get_min_value_from_matrix import get_min_value_from_matrix
