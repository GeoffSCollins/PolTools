...
from GC_bioinfo.other_programs.nt_sort_combine_gene_body_heatmap import get_combined_matrix
...
def get_args(args):
    ...
    nt, nt_distance, min_gene_length = args
...
def main(args):
    ...
    interval_size, numerator_spike_in_one, numerator_sequencing_filename_one, numerator_spike_in_two, numerator_sequencing_filename_two, \
    denominator_spike_in_one, denominator_sequencing_filename_one, denominator_spike_in_two, denominator_sequencing_filename_two, output_filename_prefix, \
    nt, nt_distance, min_gene_length = get_args(args)

    numerator_matrix = get_combined_matrix(truQuant_output_file, tsr_file, distance_past_tes, numerator_sequencing_filename_one,
                                           numerator_spike_in_one,
                                           numerator_sequencing_filename_two, numerator_spike_in_two,
                                           interval_size, upstream_distance, width, height, nt, nt_distance,
                                           min_gene_length)

    denominator_matrix = get_combined_matrix(truQuant_output_file, tsr_file, distance_past_tes, denominator_sequencing_filename_one,
                                           denominator_spike_in_one,
    ...
    fold_change_matrix_filename = make_fold_change_matrix(numerator_matrix, denominator_matrix)
    ...
    remove_files(numerator_matrix, denominator_matrix, fold_change_matrix_filename,
