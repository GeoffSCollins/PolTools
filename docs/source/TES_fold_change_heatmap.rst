...
::
  ...
  GC_bioinfo TES_fold_change_heatmap [-h] --numerator seq_file spike_in
...
.. code-block:: bash
  ...
  $ GC_bioinfo TES_fold_change_heatmap seq_file-truQuant_output.txt --numerator flavo.bed 1 --denominator dmso.bed 1 treatment -m 2
